...
<div class="container-fluid">
    ...
    <form method="POST" action="<?= base_url('bisnis/update'); ?>">
                ...
                <table class="table table-striped" style="margin-top: 10px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="nama_pic" name="nama_pic" type="text" value="<?= $detail['nama_pic'] ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="phone_pic" name="phone_pic" type="text" value="<?= $detail['phone_pic'] ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="email_pic" name="email_pic" type="text" value="<?= $detail['email_pic'] ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="expect_balance" name="expect_balance" type="text" value="<?= $balance ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <?php
                                    $transaction = "Rp " . number_format($detail['expect_transaction'], 0, ',', '.');
                                    ?>
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="expect_transaction" name="expect_transaction" type="text" value="<?= $transaction ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="expect_sv" name="expect_sv" type="text" value="<?= $sv ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input class="form-control border-0 shadow-sm bg-white rounded" id="expect_fee" name="expect_fee" type="text" value="<?= $fee ?>">
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <select name="progress_status" id="progress_status" class="form-control border-0 shadow-sm bg-white rounded">
                                        <option value="<?= $detail['id_progress_status'] ?>"> <?= $detail['progress_status'] ?> </option>
                ...
                <div class=" container-fluid border-0 shadow-sm bg-white rounded" style="height: 65.5%;">
                    ...
                    <div class="d-flex flex-column-reverse align-items-center" style="max-height: 430px; overflow-y: scroll;">
                        ...
                        <?php foreach ($record as $r) : ?>
                            ...
                            <div>O</div>
                            <div>|</div>
                            <div><?= $r['date_update'] ?></div>
                            <div><?= $r['note'] ?></div>
                            <div style="font-weight: bold;"><?= $r['progress_status'] ?></div>
                            <?= $r['status'] ?>
                        <?php endforeach; ?>
                    </div>
                </div>
